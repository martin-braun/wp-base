 ...
 * Framework Version: FACTORY_461_VERSION
 */
...
$wdan_plugin_info = [
	...
	'load_factory_modules' => [
		...
		[ 'libs/factory/freemius', 'factory_freemius_148', 'all' ],
		[ 'libs/factory/adverts', 'factory_adverts_138', 'admin' ],
		//array('libs/factory/logger', 'factory_logger_125', 'all')
	],
];

$wdan_compatibility = new Wbcr_Factory461_Requirements( __FILE__, array_merge( $wdan_plugin_info, [
