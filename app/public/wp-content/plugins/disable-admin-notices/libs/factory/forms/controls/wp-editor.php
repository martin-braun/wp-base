<?php
	...
	if( !class_exists('Wbcr_FactoryForms458_WpEditorControl') ) {

		class Wbcr_FactoryForms458_WpEditorControl extends Wbcr_FactoryForms458_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_458_URL . '/assets/css/editor.css';
				}
			}
