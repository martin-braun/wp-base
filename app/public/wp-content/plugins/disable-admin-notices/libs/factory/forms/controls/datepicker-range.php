<?php
	...
	if( !class_exists('Wbcr_FactoryForms440_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms440_DatepickerRangeControl extends Wbcr_FactoryForms440_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms440_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms440_TextboxControl($options['range_2'], $form, $provider);
