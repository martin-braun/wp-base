<?php
	...
	if( !class_exists('Wbcr_FactoryForms458_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms458_Control extends Wbcr_FactoryForms458_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms458_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms458_ValueProvider $provider
			 * @return void
			 */
