<?php
	 ...
	 *  // see FactoryForms458_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms458_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms458_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms458_DropdownAndColorsControl extends Wbcr_FactoryForms458_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms458_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms458_RadioColorsControl($options['colors'], $form, $provider);
