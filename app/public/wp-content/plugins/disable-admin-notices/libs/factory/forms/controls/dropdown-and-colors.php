<?php
	 ...
	 *  // see FactoryForms440_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms440_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms440_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms440_DropdownAndColorsControl extends Wbcr_FactoryForms440_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms440_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms440_RadioColorsControl($options['colors'], $form, $provider);
