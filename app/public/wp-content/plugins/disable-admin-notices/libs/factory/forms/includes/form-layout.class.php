<?php
	...
	if( !class_exists('Wbcr_FactoryForms440_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms440_FormLayout extends Wbcr_FactoryForms440_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-440-' . $this->type);
				$this->addCssClass('factory-forms-440-' . $this->name);
			}
