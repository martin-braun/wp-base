<?php
	...
	if( !class_exists('Wbcr_FactoryForms458_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms458_FormLayout extends Wbcr_FactoryForms458_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-458-' . $this->type);
				$this->addCssClass('factory-forms-458-' . $this->name);
			}
