<?php
	...
	if( !class_exists('Wbcr_FactoryForms458_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms458_OptionsValueProvider implements Wbcr_IFactoryForms458_ValueProvider {
