<?php
	...
	if( !class_exists('Wbcr_FactoryForms440_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms440_OptionsValueProvider implements Wbcr_IFactoryForms440_ValueProvider {
