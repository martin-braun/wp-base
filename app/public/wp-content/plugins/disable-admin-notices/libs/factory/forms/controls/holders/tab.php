<?php
	...
	if( !class_exists('Wbcr_FactoryForms458_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms458_TabHolder extends Wbcr_FactoryForms458_Holder {
			 ...
			 * @param FactoryForms458_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms458_HtmlAttributeBuilder();
