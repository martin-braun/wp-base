<?php
	...
	if( !class_exists('Wbcr_FactoryForms440_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms440_TabHolder extends Wbcr_FactoryForms440_Holder {
			 ...
			 * @param FactoryForms440_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms440_HtmlAttributeBuilder();
