<?php
	...
	if( !class_exists('Wbcr_FactoryForms440_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms440_Bootstrap3FormLayout extends Wbcr_FactoryForms440_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms440_Control $control
			 */
