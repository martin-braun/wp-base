<?php
	...
	if( !class_exists('Wbcr_FactoryForms458_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms458_Bootstrap3FormLayout extends Wbcr_FactoryForms458_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms458_Control $control
			 */
