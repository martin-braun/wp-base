...
namespace WBCR\Factory_Freemius_131\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory443_Plugin;
use WBCR\Factory_443\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_131\Premium\Provider
	 */
	private $premium;
	...
	{
		if( !$this->premium instanceof \WBCR\Factory_Freemius_131\Premium\Provider ) {
