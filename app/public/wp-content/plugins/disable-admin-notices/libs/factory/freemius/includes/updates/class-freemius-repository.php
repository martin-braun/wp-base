...
namespace WBCR\Factory_Freemius_148\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory461_Plugin;
use WBCR\Factory_461\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_148\Premium\Provider
	 */
	private $premium;
	...
	{
		if( !$this->premium instanceof \WBCR\Factory_Freemius_148\Premium\Provider ) {
