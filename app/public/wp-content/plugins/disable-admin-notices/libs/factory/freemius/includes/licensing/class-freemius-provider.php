...
namespace WBCR\Factory_Freemius_148\Premium;

use WBCR\Factory_Freemius_148\Entities\License;
use WBCR\Factory_Freemius_148\Entities\Plugin;
use WBCR\Factory_Freemius_148\Entities\Site;
use WBCR\Factory_Freemius_148\Entities\User;
use WBCR\Factory_461\Premium\Provider as License_Provider;
use Wbcr_Factory461_Plugin;
use WBCR\Factory_Freemius_148\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_148\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory461_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_148\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_148\Api
	 * @throws Exception
	 */
