 ...
 */
class Wbcr_FactoryClearfy234_PageBase extends Wbcr_FactoryPages442_ImpressiveThemplate {
	...
	/**
	 * @return Wbcr_Factory443_Request
	 */
	...
	protected function getPageWidgets($position = 'bottom')
	{
		 ...
		 */
		$widgets = wbcr_factory_443_apply_filters_deprecated('wbcr_factory_pages_442_imppage_get_widgets', [
			$widgets,
			$position,
			$this->plugin,
			$this
	...
	public function showBusinessSuggetionWidget()
	{
		 ...
		 */
		$suggetion_features = wbcr_factory_443_apply_filters_deprecated('wbcr/clearfy/page_bussines_suggetion_features', [
			$default_features,
	...
	public function showRatingWidget(array $args)
	{
		...
		$page_url = apply_filters('wbcr_factory_pages_442_imppage_rating_widget_url', $page_url, $this->plugin->getPluginName(), $this->getResultId());
		...
		<div class="wbcr-factory-sidebar-widget">
			...
			<?php if( get_locale() !== 'ru_RU' ): ?>
				<form id="wbcr-factory-paypal-donation-form" action="https://www.paypal.com/cgi-bin/webscr"
					...
					<input type="image" src="<?php echo FACTORY_PAGES_442_URL ?>/templates/assets/img/paypal-donate.png"
